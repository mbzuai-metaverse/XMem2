...
def inference_on_video(how_many_extra_frames, frames_with_masks):
    ...
    config = {
        ...
        'masks_out_path': f'../VIDEOS/RESULTS/XMem/lips/MaximumPossibleIoU/{how_many_extra_frames}_extra_frames',
        'workspace': None,
        'save_masks': True
    }
